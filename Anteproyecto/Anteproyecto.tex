...
\begin{document}
  ...
  \input{./Capitulos/1-Descripcion_problema/Descripcion_problema.tex}
  ...
  \input{./Capitulos/3-Marco_teorico/Marco_teorico.tex}
  
  \chapter{Metodología}
  
  \chapter{Métodos utilizados}
  
  \input{./Capitulos/6-Metodos/Encuesta.tex}
  
  \chapter{Cronograma}
  
  \chapter{Recursos}
  
  \input{./Capitulos/8-Recursos/Hardware.tex}
  \input{./Capitulos/8-Recursos/Software.tex}
