...
\begin{center}
	\begin{longtable}{|p{4cm}|p{7cm}|p{4cm}|}
		...
		Quién cumple la función de entrenar &
...
\begin{table}[!htb]
	...
	\begin{center}
		...
		\begin{tabular}{|p{4cm}|p{7cm}|p{4cm}|}
			...
			\textbf{Puntos de vista relacionados} \\
			\hline
			SNS Deportivo & Presenta los servicios ofrecidos a los usuarios deportistas de la red social & Punto de vista de producto \\
			\hline
			SNS Deportivo empresarial & Presenta los servicios ofrecidos a los usuarios con fines comerciales en la red social deportiva & Punto de vista de producto \\
			\hline
		\end{tabular}
		} \\
		\textbf{Fuente}: Autores
