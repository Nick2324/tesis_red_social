\begin{table}[!htb]
	\caption{CU121-Consultar noticias de jugadores: Descripción}
	\label{tab:cu121_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
			...
			\hline
			Nombre & Consultar noticias de jugadores\\
			\hline
			Identificador & CU121\\
			\hline
...
\end{table}
\begin{table}[!htb]
	\caption{CU121-Consultar noticias de jugadores:Flujos de hechos}
	\label{tab:cu121_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
			...
			\hline
				...
				3 & El usuario marca como fuente "jugadores" y regresa al listado de noticias & Se actualiza el listado de noticias para mostrar las noticias extraidas de los muros de los jugadores registrados en la aplicación.\\
			\hline
		\end{tabular}
		} \\
		\textbf{Fuente}: Autores
