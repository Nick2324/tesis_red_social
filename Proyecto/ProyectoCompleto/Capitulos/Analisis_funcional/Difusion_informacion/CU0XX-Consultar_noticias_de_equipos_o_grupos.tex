\begin{table}[!htb]
	\caption{CU119-Consultar noticias de equipos o grupos: Descripción}
	\label{tab:cu119_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
			...
			\hline
			Nombre & Consultar noticias de equipos o grupos\\
			\hline
			Identificador & CU119\\
			\hline
...
\end{table}
\begin{table}[!htb]
	\caption{CU119-Consultar noticias de equipos o grupos:Flujos de hechos}
	\label{tab:cu119_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
			...
			\hline
				...
				3 & El usuario marca como fuente "equipos o grupos" y regresa al listado de noticias & Se actualiza el listado de noticias para mostrar las noticias extraidas de los muros de los equipos o grupos registrados en la aplicación.\\
			\hline
		\end{tabular}
		} \\
		\textbf{Fuente}: Autores
