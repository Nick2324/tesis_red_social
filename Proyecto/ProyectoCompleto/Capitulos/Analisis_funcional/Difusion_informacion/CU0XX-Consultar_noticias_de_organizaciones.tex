\begin{table}[!htb]
	\caption{CU122-Consultar noticias de organizaciones: Descripción}
	\label{tab:cu122_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
			...
			\hline
			Nombre & Consultar noticias de organizaciones\\
			\hline
			Identificador & CU122\\
			\hline
...
\end{table}
\begin{table}[!htb]
	\caption{CU122-Consultar noticias de organizaciones:Flujos de hechos}
	\label{tab:cu122_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
			...
			\hline
				...
				3 & El usuario marca como fuente "Organizaciones" y regresa al listado de noticias & Se actualiza el listado de noticias para mostrar las noticias extraidas de los muros de las organizaciones.\\
			\hline
		\end{tabular}
		} \\
		\textbf{Fuente}: Autores
