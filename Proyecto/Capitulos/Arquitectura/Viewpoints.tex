...
\begin{table}[!htb]
	...
	\begin{center}
		...
		\begin{tabular}{|p{7cm}|p{4cm}|}
			...
			\hline \hline
			\begin{itemize}
				\item \textbf{Formadores de grupo deportivo (Colaboración):} 
				\item \textbf{Agrupación deportiva (Rol):} 
				\item \textbf{Entrenador deportivo (Rol):} 
				\item \textbf{Gestión de grupo deportivo (Función):} 
				\item \textbf{Difusión del grupo deportivo (Función):} 
				\item \textbf{Control de unión de miembros(Función):} 
				\item \textbf{Difusión de información deportiva (Función):} 
			\end{itemize} 
			&
			\begin{itemize}
