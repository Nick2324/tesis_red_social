	...
	\begin{center}
		...
		\begin{tabular}{|p{7cm}|p{4cm}|}
			...
			********************************************
			...
			&
			\begin{itemize}
				\item Rol - actor, Bussiness process - (Entrenamiento deportivo, estadísticas deportivas, organización de eventos deportivos, formación de grupos deportivos, patrocinios deportivos)
				\item Rol - actor, Bussiness process - (Entrenamiento deportivo)
				\item Rol - actor, Bussiness process - (Entrenamiento deportivo, estadísticas deportivas, formación de grupos deportivos, patrocinios deportivos)
				\item N/A
				\item N/A
				\item N/A
...
\begin{table}[!htb]
	\caption{Descripción Patrocinio Deportivo}
