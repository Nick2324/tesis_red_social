\begin{table}[!htb]
	\caption{CU124-Consultar noticias deportivas internas: Descripción}
	\label{tab:cu124_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
			...
			\hline
			Nombre & Consultar noticias deportivas internas\\
			\hline
			Identificador & CU124\\
			\hline
...
\end{table}
\begin{table}[!htb]
	\caption{CU124-Consultar noticias deportivas internas:Flujos de hechos}
	\label{tab:cu124_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
