...
\begin{table}[!htb]
	\caption{CU024-Consultar participantes: Descripción}
	\label{tab:cu024_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
			...
			Identificador & CU024 \\
			\hline
			Descripción & Permite consultar los participantes del evento \\
			\hline
			Actor & Todo actor de la red social	 
			\\
			\hline
			Disparador & Se elige la opción de consultar los participantes del evento \\
			\hline
			Inclusiones & N/A \\
			\hline
			Puntos de extensión & N/A \\
			...
			Postcondiciones & 
			\begin{itemize}
				\item El usuario se encuentra en la pantalla de consulta de participantes
			\end{itemize}
			\\
			\hline
			Notas & N/A
