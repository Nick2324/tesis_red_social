...
\input{./Capitulos/Analisis_funcional/Gestion_patrocinios/}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar elementos de patrocinio: Descripción}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar elementos de patrocinio: Flujos de hechos}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar material de patrocinio: Descripción}
	\label{tab:cu041_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar material de patrocinio: Flujos de hechos}
	\label{tab:cu041_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar servicios de patrocinio: Descripción}
	\label{tab:cu041_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
...
\begin{table}[!htb]
	\caption{CU041-estionar servicios de patrocinio: Flujos de hechos}
	\label{tab:cu041_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar capacidad de financiamiento: Descripción}
	\label{tab:cu041_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
...
\begin{table}[!htb]
	\caption{CU041-Gestionar capacidad de financiamiento: Flujos de hechos}
	\label{tab:cu041_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
