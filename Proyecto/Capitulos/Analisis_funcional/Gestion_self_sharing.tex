\clearpage
\begin{table}[!htb]
	\caption{CU001-Gestionar self-sharing: Descripción}
...
\begin{table}[!htb]
	\caption{CU001-Gestionar self-sharing: Flujos de hechos }
...
\begin{table}[!htb]
	\caption{CU001-Gestionar timeline: Descripción}
	\label{tab:cu001_desc}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{4cm}|p{11cm}|}
...
\begin{table}[!htb]
	\caption{CU001-Gestionar timeline: Flujos de hechos }
	\label{tab:cu001_flujo}
	\begin{center}
		\resizebox{15cm}{!}{
		\begin{tabular}{|p{1.5cm}|p{6cm}|p{6.5cm}|}
