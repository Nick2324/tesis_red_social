\begin{table}[!htb]
	\caption{Relación UbicacionEvento}
	\label{tab:xxxx_rel}
	\begin{center}
		\resizebox{16cm}{!}{
		\begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}
			...
			\multicolumn{2}{c|}{Relación que existe entre una ubicación y un evento deportivo}  \\
			\hline
