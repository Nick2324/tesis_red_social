...
Para el prototipo, se ha realizado solamente un evento de práctica deportiva (de caracter libre). El modelo generado se puede apreciar en la figura \ref{fig:modelo_datos_gestion_eventos}.
