 ...
 */
public class PeticionUnirseEvento extends Peticion {
    ...
    public PeticionUnirseEvento(Context context, String tipoEvento, Evento evento, Usuario usuario, Bundle datosIntent) {
            ...
            try {
                ...
                if(resultado.getString("caracterAceptacion") != null &&
                    ...
                    Toast.makeText(this.context, this.context.getResources().
                                    getString(R.string.toast_une_evento),
