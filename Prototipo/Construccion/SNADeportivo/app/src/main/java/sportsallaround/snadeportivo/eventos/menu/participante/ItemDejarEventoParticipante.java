...
import sportsallaround.snadeportivo.eventos.peticiones.PeticionDejarEvento;
 ...
 */
public class ItemDejarEventoParticipante extends ItemMenuSNS{

    public ItemDejarEventoParticipante(int idItem){
        super(idItem);
    }
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    ...
                                    new PeticionDejarEvento(contexto,
